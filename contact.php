...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main_txt">
            ...
            <div class="desc">
                궁금하신 점 문의남겨주시면 확인되는대로 연락드리겠습니다 :)
            </div>
        </div>
        <div class="main_list">
            <form action="/submit/contact.php" id = "contact" method = "POST">
                <div class="input_title" style="top: 56px; left: 18px;">성함</div>
                <input type="text" name = "name" style="top: 56px; left: 140px; width: 273px; height: 38px;">

                <div class="input_title" style="top: 116px; left: 18px;">업체명</div>
                <input type="text" name = "corp" style="top: 116px; left: 140px; width: 273px; height: 38px;">

                <div class="input_title" style="top: 176px; left: 18px;">전화번호</div>
                <input type="number" name = "num1" maxlength="3" oninput="numberMaxLength(this);"
                    style="top: 176px; left: 140px; width: 77px; height: 38px; text-align: center;">
                <div class="p_bar" style="top: 195px; left: 221.3px;"></div>
                <input type="number" name = "num2" maxlength="4" oninput="numberMaxLength(this);"
                    style="top: 176px; left: 238px; width: 77px; height: 38px; text-align: center;">
                <div class="p_bar" style="top: 195px; left: 319.3px;"></div>
                <input type="number" name = "num3" maxlength="4" oninput="numberMaxLength(this);"
                    style="top: 176px; left: 336px; width: 77px; height: 38px; text-align: center;">

                <div class="input_title" style="top: 234px; left: 18px;">이메일</div>
                <input type="text"  name = "email" style="top: 234px; left: 140px; width: 273px; height: 38px;">

                <div class="input_title" style="top: 294px; left: 18px">문의내용</div>
                <textarea name = "content" style="top: 294px; left: 140px; width: 852px; height: 288px;"></textarea>
                <div class="contact_btn" style="top: 647px; left: 866px;" onclick = "$('#contact').submit()">문의하기 ></div>
            </form>
        </div>
        <footer>
            <div id="footer_02">
