...
function search() {
    $('html, body').animate({
        scrollTop: $(".search_area").offset().top - 700
    }, 1000);
}
function faq() {
    $('html, body').animate({
        scrollTop: $(".faq_area").offset().top
    }, 1000);
}

$(".faq_item").click(function () {
    $(this).children(".faq_detail").slideToggle();
...
$(window).scroll(function () {
    ...
    if (scrollValue >= 0 && scrollValue < $(".search_area").offset().top - 701) {
        $(".left_side_bar > ul > li").removeClass("on");
        $(".left_side_bar > ul > li:nth-child(1)").addClass("on");
    }
    else if (scrollValue >= $(".search_area").offset().top - 701 && scrollValue < $(".faq_area").offset().top - 301) {
        $(".left_side_bar > ul > li").removeClass("on");
