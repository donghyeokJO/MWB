    ...
    <div class="wrapper">
        <header>
            ...
            <div class="user">
                ...
                <div class="user_menu">
                   <a href="/logout">LOGOUT</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">MY PAGE</a>
                </div>
            </div>
        </header>
        <div class="info">
            ...
            <form id="signup_form_01" method="POST" action="signup.php">
                <div class="row">
                    <div class="col-12 margin_top_l">이메일</div>
                    <div class="col-12 margin_top_s">
                        <input type="email" name="u_email" placeholder="이메일 주소를 입력해주세요." required="" value="<?= $user['u_email']?>" readonly/>
                    </div>
                    <div class="col-12 margin_top_l">이름</div>
                    <div class="col-12 margin_top_s">
                        <input type="text" name="u_name" placeholder="이름을 입력해주세요." required="" value="<?= $user['u_name']?>" readonly/>
                    </div>
                    <div class="col-12 margin_top_l">업체명</div>
                    <div class="col-12 margin_top_s">
                        <input type="text" name="enterprise" placeholder="업체명을 입력해주세요" required="" value="<?= $user['corp']?>" readonly/>
                    </div>
                    <div class="col-12 margin_top_l">연락처</div>
                    <div class="col-12 margin_top_s position_relative">
                        <input type="text" name="u_phone" placeholder="연락처를 입력해주세요" required="" value="<?= $user['u_phone']?>" readonly/>

                    </div>
                    <!-- <div class="col-12 margin_top_l">생년월일</div>
                    <div class="col-12 margin_top_s position_relative">
                        <input type="text" name="u_phone" placeholder="생년월일을 입력해주세요" required="" value="1234년 56월 78일" readonly/>
                    </div> -->
                </div>
                <div class="user_btn">
                    <a href="#">비밀번호 변경</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="http://m.me/makewebnbot">회원탈퇴</a>
                </div>
            </form>
        </div>
        <footer>
