...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main_txt">
            <div class="title">
                WE WILL DESIGN A SMART Chatbot
            </div>
            <div class="desc">
                챗봇을 이용해서 직원 인건비를 줄이고 매출을 늘려보세요. <br>
                카카오톡, 페이스북, 라인 등 SNS와 연동이 가능합니다.
            </div>
        </div>
        ...
        <div class="chatbot">
            <div class="chatbot_title">
                <div class="big">“</div>
                <div class="cb_title_txt">챗봇 개발을 위해 아래의 사항을 준비해주세요</div>
                <div class="big">”</div>
            </div>
            ...
            <div class="chatbot_contents">
                <div class="part">
                    <div>1. Flowchart</div>
                    <div>챗봇으로 구현하고자 하는 채팅 프로세스 (최대한 상세하게)</div>
                </div>
                <div class="part">
                    <div>2. Links</div>
                    <div>챗봇에서 연결할 링크페이지 주소</div>
                </div>
                <div class="part">
                    <div>3. Chatposts</div>
                    <div>
                        <div>채팅 멘트, 30개 이내 추천</div>
                        <div>보통은 30개 이내로 충분하며 상담원을 연결하는 것이 초기 판매율을 높이기에 유리합니다.
                            40개 이상부터는 추가 개발이 필요하여 추가금이 발생 가능합니다.</div>
                    </div>
                </div>
                <div class="contact_btn"
                    onclick="window.open('about:blank').location.href='https://m.me/makewebnbot'" style = "text-decoration:none">문의하기 ></div>
            </div>
